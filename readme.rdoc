...
then in your views you can do
  ...
  if no one is logged in, current_user returns a GuestUser instance which responds to guest?
  with true, permission_level with 0 and any other method calls with false
...
you can use the render_login_logout helper to render links to login/logout and register/edit account links based on whether the user is logged in or not.
...
the routes defined by this plugin are:
get      '/login'
get      '/logout'
get      '/signup'
get/post '/users'
